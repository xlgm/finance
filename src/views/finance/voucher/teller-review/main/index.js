...
@inject('voTellerStore','appStore') @observer
class TellerMain extends React.Component {
  ...
  render() {
       let { voTellerStore, appStore } = this.props;
       const date = [];
       const dateChildren = [];
    ...
    return (
      ...
      <div className="voucher_teller_main">
        <div className="btn_group">
          <WhiteButton>出纳复核</WhiteButton>
        ...
        <div className="table_block">
          <Table
            ...
            bordered
            onRowClick={()=>{
              appStore.openNewTab(appStore.ALL_MENU.voucher_teller_detail);
            }}
            scroll={{ x: 2000, y: 330 }}
            pagination={{  //分页
