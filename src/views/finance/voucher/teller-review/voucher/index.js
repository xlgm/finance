...
import './voucher_teller_detail.less';

@inject('voTellerStore')@observer
class VoucherTeller extends Component {
  ...
  render() {
    ...
    return <div 
      className='voucher_teller_detail'
      style={{
        width: '100%',
        height: '100%',
        position: 'relative'
      }}>
      <div className="teller_detail_content">
        <div className="btn_group">
        <Row>
          <Col span={20}>
            <PurpleButton>出纳复核</PurpleButton>
