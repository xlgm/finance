...
import './cash-joumal.less'

@inject('cashAccountStore') @observer
class CashAccountContainer extends Component {
  ...
  componentWillUnmount() {
    // let {cashAccountStore} = this.props;
    // cashAccountStore.changePageControl('');
  }
  // 币别选择
  ...
  render() {
    ...
    return <div style={{
      ...
      <div className="cash-joumal-top">
        <Row>
          ...
          <Col span={7}>
            ...
            <span className="cash-joumal-and">至</span>
            <Cascader
              options={date}
              style={{ width: 120, fontSize: 14, }}
              onChange={this.dateChange}
          ...
          <Col span={2} style={{ marginTop: 3 }}>
            <AdvancedQuery
              ...
              onOk={() => { }}
            >
              <div className="cash-joumal-contentDiv-nav">
                <Row>
                  <Col span={4}>
                    <span>核算组织</span>
                  </Col>
      ...
      <div className="cash-joumal-table">
