...
import Subject from './detail-subject';
...
class DetailAccountContainer extends Component {
  ...
  componentWillUnmount() {
    ...
    // detailAccountStore.changePageControl('');
  }
  // 树状选择
  handleSelectedBytree = (selectedKeys, e) => {
    if (e.selected && selectedKeys - 0 !== 0) {
      this.state.treeName = e.selectedNodes.map((k) => {
  ...
  render() {
    ...
    let treeData = [];
    let treeName = '';
    treeData = (detailAccountStore.treeData && detailAccountStore.treeData.data.map(tItem => {
      tItem.key = tItem.id;
      treeName = tItem.name
      return tItem;
    }));
    ...
    return <div style={{
      ...
      <div className="detail-account-top">
        <Row>
          ...
          <Col span={7}>
            ...
            <span className="detail-top-and">至</span>
            <Cascader
              options={date}
              style={{ width: 120, fontSize: 14, }}
              onChange={this.dateChange}
          ...
          <Col span={3} style={{ marginTop: 3 }}>
            <AdvancedQuery
              ...
              onOk={() => { }}
            >
              <div className="detail-contentDiv-nav">
                <Row>
                  <Col span={3}>
                    <span>核算组织</span>
                  </Col>
                ...
                <Row>
                  ...
                  <Col span={8}><Checkbox>只显示最明细科目</Checkbox></Col>
                ...
                <Row>
                  ...
                  <Col span={8}><Checkbox>显示对方科目</Checkbox></Col>
                </Row>
              </div>
            </AdvancedQuery>
          </Col>
      ...
      <div className="detail-account-middle">
        <span>科目：{this.state.treeName ? this.state.treeName : treeName}</span>
      </div>
      <div className="detail-account-table">
        <div className="detail-account-table-table">
        ...
        <div className="detail-account-table-tree">
          <div className="certain-category-search-wrapper">
            <AutoComplete
              className="certain-category-search"
              dropdownClassName="certain-category-search-dropdown"
